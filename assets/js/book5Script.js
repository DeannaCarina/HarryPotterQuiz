...
generateQuiz(book5Questions, containerOfQuiz, containerOfResults, submitQuizButton, containerOfHome);
...
function generateQuiz(questions, containerOfQuiz, containerOfResults, submitQuizButton){
  ...
  function showResults(questions, containerOfQuiz, containerOfResults, containerOfHome){
    ...
    containerOfHome.innerHTML = '<a href="../index.html" class="home-link link-5"><i class="fas fa-home"></i></a>';
  }
